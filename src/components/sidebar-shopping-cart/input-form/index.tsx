...
const onClickSubmitReset = () => {
  ...
  return (
    <form onSubmit={handleSubmit} autoComplete="off">
      <div className={isFormSubmitted ? styles.success : styles.formHidden}>
        Спасибо! Заказ оформлен. Пожалуйста, подождите. Идет переход к оплате...
      </div>
      <div className={isFailSubmitted ? styles.fail : styles.formHidden}>
        Упс...Что-то пошло не так.
      </div>
      <div className={isFormSubmitted ? styles.formHidden : styles.formVisible}>
        ...
        <div
          className={cn(styles.sumContainer, styles.sumContainerSmallerWidth)}
        >
          <Typography.TitleResponsive
            className={styles.titleText}
            view="xsmall"
